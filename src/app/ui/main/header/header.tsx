...
export const Header = (): JSX.Element => {
  ...
  return (
    <header style={{backgroundColor:'#2D4059'}} className="relative z-10 flex w-full items-center justify-between bg-white py-2 px-5 shadow-[0_1px_5px_-1px_rgba(0,0,0,0.3)] dark:bg-dark-200">
      <section>
        <Link
          to="/"
        ...
        >
          ...
          <span style={{color:'white'}}  className="ml-2">swiftScrum</span>
        </Link>
      </section>
