...
export const ProjectsView = ({
  ...
  return (
    <div style={{backgroundColor:'#2D4059',height:'100vh'}} className="bg-white p-6 dark:bg-dark-400">
      <h1 style={{color:'#ffd460',marginLeft:'300px'}} className="font-primary-black text-2xl">WORKSPACE</h1>
      ...
      <Outlet />
      <Link style={{backgroundColor:'#ffd460',marginLeft:'300px',borderRadius:'20px'}}
        to="new"
...
const ProjectCard = ({ project }: ProjectCardProps): JSX.Element => {
  ...
  return (
    <div className="w-[400px]">
      <Link style={{display:'flex',flexDirection:'column',backgroundColor:'#ffd460', borderRadius:'20px',width:'300px'}}
        to={project.id}
        className={cx(
      ...
      >
        <img style={{borderRadius:'20px',width:'80px', height:'80px',margin:'10px'}}
